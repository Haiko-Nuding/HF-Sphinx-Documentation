...
Use the sections below to explore the main topics, examples, and guides
that make up this documentation set.
...
This section displays the **current color palette** applied to this Sphinx documentation theme.
It provides a visual reference of the colors used,
so you can maintain consistent styling across your documentation.

.. raw:: html
    :file: _static/tofo-color-palette.html
